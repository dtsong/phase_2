module Contexts
	...
	# Context for addresses
		def create_addresses
			...
			@liferay = FactoryGirl.create(:address, customer: @peter, is_billing: false, recipient: "Peter Bugbee", street_1: "1400 Montefino Ave", street_2: nil, city: "Diamond Bar", state: "CA", zip: "91765")
			...
			@uchicago = FactoryGirl.create(:address, customer: @sibo, is_billing: false, recipient: "Sibo Cai", street_1: "5801 S Ellis Ave", city: "Chicago", state: "IL", zip: "60637")
		end
